...
# ╔═╡ ce40f3ae-c2a9-40a9-a4fa-4b7fe5a60f53
...
# ╔═╡ b5e23e9f-6575-4b4d-bf64-5222ff15a05d
#=╠═╡
X_train
  ╠═╡ =#
...
begin
	...
	img = load(data)
	img = center_square_crop(img, 51)
end
  ╠═╡ =#

# ╔═╡ 63471f97-67ba-45c2-933c-13e5516b7835
#=╠═╡
begin
	using FileIO
	file_path="/Users/kevinoregan/Desktop/Dropbox/Temporary/Grid6.jpg"
	img = FileIO.load(file_path)
	img = center_square_crop(img, 50)
end
...
manifest_format = "2.0"
project_hash = "3123a9bd3c375ed9cefef73151cf5dd030f7f2c2"
