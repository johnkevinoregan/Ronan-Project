...
# ╔═╡ 8cfb9c51-64d5-4726-aa1c-9fcdacad2cdf
HTML("""

<div>
  <button id="mystop" style="background:#b00020; color:white;">
    Halt
  </button>

  <script>
    const div    = currentScript.parentElement
    const button = div.querySelector("#mystop")

    button.onclick = function () {
      console.log("Setting halt flag")
      window.halt_flag = true
    }
  </script>
...
# ╔═╡ 81948475-8f04-43e8-8e20-967c583a6bd5
halt_flag = Ref(false)
...
begin
	...
	img = load(data)
	img = center_square_crop(img, 512)
end
...
# ╔═╡ 51c79013-e0c9-4022-b57a-a0619ee39bf6
X_train_test = X_train[:, 1:100]

# ╔═╡ 8cc6f7d8-42fb-4317-8913-f69775ed931e
gen_nhot_dict(X_train_test, 256, 4, used_patterns)

# ╔═╡ d58129d7-bde2-42fd-a3bf-a3f578ddead1
typeof(X_train[:, 1])

# ╔═╡ 2f87ef91-dbd2-4354-b602-1e1f0f2a8bec
size(X_train_test, 2)

# ╔═╡ 5c3a4d03-ec0e-4b64-bb2b-3b85fd9f60be
length(used_patterns)

# ╔═╡ d7826e8d-c308-4cab-a6ab-adc3631e4e59
countmap(values(used_patterns))

# ╔═╡ aa5ffb20-0dd1-4c92-917f-df88ff8ed679
used_patterns
...
begin
	...
	# Define the Model
	model = Chain(
		FeatureMap(X_train, mapping_size, 4, filter_NHot), # Inputs: 2 -> 256
		Dense(256, 256, relu),
	    Dense(256, 256, relu),
	    Dense(256, 3, sigmoid)
	)
...
manifest_format = "2.0"
project_hash = "b0b6f11dc4f8f8e80a6d6fee96578c3b5fe6431e"
