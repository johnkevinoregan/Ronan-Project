...
# ╔═╡ 27c02734-825b-4539-b793-8d76394eb4f3
using SparseArrays
...
# ╔═╡ 2dc5f6f7-c920-49c7-b28e-993ff9c393a1
...
# ╔═╡ 57a340d2-7d44-4fe8-9c97-6e65843741b0
...
# ╔═╡ a4fcd956-efe7-4d5f-9be4-3c9226343edd
[ [x, y] for y in ys, x in xs ] 


# ╔═╡ 1adf4d8d-b783-4be7-9d16-f77d050594e2
X_train
...
begin
	...
	filter_hash(x) = dense.(hash_k_sparse_exact.(x; M=10, k=3)) #I should have M=mapping_size but it gives error: cyclic dependency, so I just put in M=10 as literal.
	#BUT MORE IMPORTANT: propagating the hashing over x doesnt seem to be doing it over columns... also I wasnt sure whether I should put a dot after dense as well as after hash_k_sparse_exact .... ????
...
# ╔═╡ 0191f00a-41e3-43ba-9cd8-c92f0fe939b9
...
# ╔═╡ 9812bd73-f36e-4df3-808a-97f09db526da
FeatureMap(X_train, filter_ft)
...
manifest_format = "2.0"
project_hash = "52d4ea6e6ea80ea3497b7a223a76fa75e3d619fe"
