...
# ╔═╡ 048ee203-4896-4356-99a5-97f84903017e
HTML("""
<!-- the wrapper span -->
<div>
...
# ╔═╡ 0be7c4c9-fa05-420a-a798-2960fe31f909
recon = reshape(model(X_train), (3, crop_size, crop_size))

# ╔═╡ 1e68da71-64b7-4356-a048-bbe63cb25e26
colorview(RGB, recon)
...
# ╔═╡ b3fe55b7-442d-4572-b934-06814fcd8bed
# ╠═╡ disabled = true
#=╠═╡
let model=model
	# How to load a saved model
	@load "fox_FT_2000.jld2" model_state opt_state epoch losses
...
manifest_format = "2.0"
project_hash = "274378dcaeb06187d7d32000edaff8dfa2a4c5b3"
